#
# Be sure to run `pod lib lint NHSearchViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/NHSearchViewController.git", :tag => s.version.to_s }
  ...
  s.resource_bundles = {
    'NHSearchViewController' => ['Pod/Assets/*.png']
  }
